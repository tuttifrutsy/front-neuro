<template>
  ...
  <div id="app">
    <div>
      <header class="header">
        <router-link class="title" to="/">NeuroAMY</router-link>
                  ...
                  <ul class="header__dropdown-menu-nav">
                    <li class="header__dropdown-menu-item">
                      <router-link to="/login">
                        <a href="#" to="/login" class="header__dropdown-menu-link" title="Account">
                          ...
                          <div class="header__dropdown-menu-text">Soy Paciente</div>
                        </a>
                      </router-link>
                    </li>
                    <li class="header__dropdown-menu-item">
                      <router-link to="/info">
                        <a href="#" class="header__dropdown-menu-link" title="Personal info">
                          ...
                          <div class="header__dropdown-menu-text">Info</div>
                        </a>
                      </router-link>
                    </li>
                    <li class="header__dropdown-menu-item">
                      <router-link to="/signup">
                        ...
                        >
                          ...
                          <div class="header__dropdown-menu-text">Registrarse</div>
                        </a>
                      </router-link>
                    </li>
                    <li class="header__dropdown-menu-item">
                      <router-link to="/tramites">
                        ...
                        >
                          ...
                          <div class="header__dropdown-menu-text">Tramites</div>
                        </a>
                      </router-link>
                    </li>
                    <li class="header__dropdown-menu-item">
                      <router-link to="/neurogram">
                        <a href="#" class="header__dropdown-menu-link" title="People & sharing">
                          ...
                          <div class="header__dropdown-menu-text">Ayuda a Otros</div>
                        </a>
                      </router-link>
                    </li>
                    <hr />
                    <li class="header__dropdown-menu-item">
                      <router-link to="/preguntas">
                        <a href="#" class="header__dropdown-menu-link" title="Help">
                          ...
                          <div class="header__dropdown-menu-text">Preguntas</div>
                        </a>
                      </router-link>
                    </li>
                  </ul>
